...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:5kGOVHlq0euqwzgTC9Vu15p6fV1Wi0ArVi8da2urnVg=",
        version = "v0.0.0-20201016165138-7b1cca2348c0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_gofiber_fiber",
        importpath = "github.com/gofiber/fiber",
        sum = "h1:QRUPvPmr8ijQuGo1MgupHBn8E+wW0IKqiOvIZPtV70o=",
        version = "v1.14.6",
    )
    go_repository(
        name = "com_github_gofiber_utils",
        importpath = "github.com/gofiber/utils",
        sum = "h1:3Mr7X7JdCUo7CWf/i5sajSaDmArEDtti8bM1JUVso2U=",
        version = "v0.0.10",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rMS4CL3pNmYq1V5/X+nHHjh1Dx6dnf27+Cai5zabo+M=",
        version = "v1.20.7",
    )
    go_repository(
